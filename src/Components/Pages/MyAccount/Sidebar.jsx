  ...
  return (
    <div className="w-full lg:w-80 bg-gray-100 flex flex-col p-4 lg:p-10 lg:flex-shrink-0">
      ...
      <nav className="flex-1">
            ...
            >
              <img
                ...
                className={`w-4 h-4 flex-shrink-0 ${
                  activeItem === "pet" ? "brightness-0 lg:invert" : ""
                }`}
              />
          ...
          <li>
            ...
            >
              <img
                ...
                alt=""
                className={`w-4 h-4 flex-shrink-0 ${
                  activeItem === "support" ? "brightness-0 lg:invert" : ""
                }`}
              />
        ...
        lg up. */}
              <span className="flex-1 text-left break-words lg:hidden">
                {t("supportShort")}
              </span>
              <span className="flex-1 text-left break-words hidden lg:block">
                {t("support")}
              </span>
            </button>
          </li>
