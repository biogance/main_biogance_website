...
export default function BioganceAmbassadorForm() {
  ...
  const tabs = [
    ...
    { key: "clubAssociation", label: t("ambassador.tabs.clubAssociation") },
    {
      ...
      label: t("ambassador.tabs.healthProfessional"),
    },
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedTab !== "animalWelfare" && selectedTab !== "clubAssociation") {
    ...
    if (selectedTab === "Content Creator") {
      ...
      if (
        !formData.hasMultipleAnimals ||
        formData.hasMultipleAnimals.trim() === ""
      ) {
        newErrors.hasMultipleAnimals =
          "Please select if you have one or more animals";
      }
      ...
      if (
        ...
        (!animalForms[0].species || animalForms[0].species === "")
      ) {
    ...
    // Breeder Tab
      ...
      if (
        !formData.breedingDuration ||
        formData.breedingDuration.trim() === ""
      ) {
      ...
      if (
        !formData.familiarWithProducts ||
        formData.familiarWithProducts.trim() === ""
      ) {
        newErrors.familiarWithProducts =
          "Please select if you are familiar with our products";
      }
    }
    ...
    // Club or Association Tab
      ...
      // Collaboration validation
      if (
        !formData.collaborationReason ||
        formData.collaborationReason.trim() === ""
      ) {
        newErrors.collaborationReason =
          "Please tell us why you want to collaborate";
      }

      if (
        !formData.promotionActions ||
        formData.promotionActions.trim() === ""
      ) {
      ...
      if (!agreeToReview) {
        newErrors.agreeToReview =
          "You must agree to the review of your application";
      }
    }
    ...
    if (!agreeToReview) {
      newErrors.agreeToReview =
        "You must agree to the information review to submit";
    }
    ...
    // API call based on tab
    try {
      setIsLoading(true);
      let body = {};

      if (selectedTab === "contentCreator") {
        body = {
          ...
          city: formData.cityRegion2,
          social_link: formData.socialMediaLink,
          follower: formData.followers,
          theme: formData.mainTheme,
          theme1: formData.mainThemeText,
          content: formData.contentType,
          pets: formData.petType,
          theme2: formData.petMainTheme,
          no_of_animal: formData.hasMultipleAnimals,
          animal: animalForms.map((a) => ({
            species: a.species,
            breed: a.breed,
            cost: a.coatType,
            needs: a.characteristics,
          })),
          why: motivation,
        };
      } else if (selectedTab === "breeder") {
        body = {
          ...
          contact: formData.contact,
          city: formData.cityRegion2,
          breed: formData.speciesBreed,
          breed_name: formData.breedName,
          main_breed: formData.mainBreedId,
          how_long_breeding: formData.breedingDuration,
          breeding_size: formData.breedingSize,
          already_familiar: formData.familiarWithProducts,
          like_to: formData.idealPartnership,
          why: motivation,
        };
      } else if (selectedTab === "groomer") {
        body = {
          ...
          contact: formData.contact,
          city: formData.cityRegion2,
          main_speciality: formData.speciesBreed,
          other_speciality: formData.breedName,
          link_to_account: formData.onlinePresenceLink,
          like_to: formData.idealPartnership,
          why: motivation,
        };
      } else if (selectedTab === "clubAssociation") {
        body = {
          type: "club",
          organization_name: formData.firstName,
          email: formData.email,
          contact: formData.contact,
          city: formData.cityRegion2,
          why: formData.collaborationReason,
          type_organization: formData.organizationType,
          organization: formData.organizationName,
          active_member: formData.memberCount,
          event: formData.organizeEvents,
          breed_represented: breedGroups.map((g) => ({
            species: g.species,
            main_breed: g.mainBreeds,
          })),
          like_to: formData.idealPartnership,
          type_of_action: formData.promotionActions,
          other_type_of_action: formData.otherPromotionActions,
        };
      } else if (selectedTab === "healthProfessional") {
        body = {
          ...
          contact: formData.contact,
          city: formData.cityRegion2,
          organization_name: formData.clinicName,
          main_speciality: formData.profession,
          other_speciality: formData.otherProfession,
          how_long: formData.yearsExperience,
          mainly_work: formData.mainWorkWith,
          already_familar: formData.familiarWithBiogance,
          like_to: formData.participateIn,
          why: formData.expertTopics,
        };
      } else if (selectedTab === "animalWelfare") {
        body = {
          type: "animal",
          email: formData.email,
          contact: formData.contact,
          ...
          siren_number: formData.rinaSirenNumber,
          no_of_animal: formData.animalsInCare,
          species_concered: formData.speciesConcerned,
          how_hear: formData.hearAboutBiogance,
          most_useful: formData.usefulProducts,
          other_product: formData.otherProducts,
          like_to: formData.shareInitiatives,
          why: formData.shelterMessage,
        };
      }
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        {errors.firstName && (
                          <p className="mt-1 text-xs text-red-600">
                            {t("ambassador.common.errors.firstNameRequired")}
                          </p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.lastName && (
                          <p className="mt-1 text-xs text-red-600">
                            {t("ambassador.common.errors.lastNameRequired")}
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        {errors.contact && (
                          <p className="mt-1 text-xs text-red-600">
                            {t("ambassador.common.errors.contactRequired")}
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-5">
                      <div>
                        ...
                        {errors.cityRegion2 && (
                          <p className="mt-1 text-xs text-red-600">
                            {t("ambassador.common.errors.cityRegionRequired")}
                          </p>
                        )}
                      </div>
                      <div></div>
                      ...
                      <div className="p-6 space-y-7">
                        ...
                        <div>
                          ...
                          {errors.socialMediaLink && (
                            <p className="mt-1 text-xs text-red-600">
                              {t(
                                "ambassador.contentCreator.errors.socialMediaLinkRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.contentCreator.options.followers", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                              ...
                              >
                                ...
                                />
                                <span className="ml-3 text-xs text-gray-800">
                                  {option}
                                </span>
                              </label>
                            ))}
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.contentCreator.options.mainThemes", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                          ...
                          {errors.mainTheme && (
                            <p className="mt-1 text-xs text-red-600">
                              {t(
                                "ambassador.contentCreator.errors.mainThemeRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t(
                              "ambassador.contentCreator.options.contentTypes",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.contentCreator.options.petTypes", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-900 mb-2">
                            {t(
                              "ambassador.contentCreator.doYouHaveMultipleAnimals",
                            )}
                          </label>
                          ...
                          <div className="space-y-3">
                            {t(
                              "ambassador.contentCreator.options.multipleAnimals",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                              ...
                              >
                                <input
                                  ...
                                  value={option}
                                  checked={
                                    formData.hasMultipleAnimals === option
                                  }
                                  onChange={(e) => {
                                    handleInputChange(e);
                            ...
                            {errors.hasMultipleAnimals && (
                              <p className="mt-1 text-xs text-red-600">
                                {t(
                                  "ambassador.contentCreator.errors.hasMultipleAnimalsRequired",
                                )}
                              </p>
                            )}
                          </div>
                        ...
                        {animalForms.map((animal, index) => (
                          <div
                            key={animal.id}
                            className="border-t border-gray-300 pt-7 pb-4"
                          >
                            <h3 className="text-sm font-semibold text-gray-900 mb-5">
                              {t("ambassador.contentCreator.animalNumber")}{" "}
                              {index + 1}
                              {index > 0 &&
                                ` ${t("ambassador.contentCreator.optional")}`}
                            </h3>

                            {/* Species */}
                            <div className="mb-6">
                              <label className="block text-sm font-medium text-gray-900 mb-3">
                                {t("ambassador.contentCreator.animalSpecies")}
                              </label>
                              <div className="flex flex-wrap gap-4">
                                {t(
                                  "ambassador.contentCreator.options.species",
                                  { returnObjects: true },
                                ).map((opt) => (
                                  <label
                                    key={opt}
                              ...
                              {errors.animalSpecies && (
                                <p className="text-xs text-red-600 mt-2">
                                  {t(
                                    "ambassador.contentCreator.errors.animalSpeciesRequired",
                                  )}
                                </p>
                              )}
                            </div>
                            ...
                            <div className="mb-6">
                              <label className="block text-sm font-medium text-gray-900 mb-2">
                                {t("ambassador.contentCreator.breed")}
                              </label>
                              <input
                                type="text"
                                value={animal.breed}
                            ...
                            <div className="mb-6">
                              <label className="block text-sm font-medium text-gray-900 mb-3">
                                {t("ambassador.contentCreator.coatType")}
                              </label>
                              <div className="flex flex-wrap gap-4">
                                {t(
                                  "ambassador.contentCreator.options.coatTypes",
                                  { returnObjects: true },
                                ).map((opt) => (
                                  <label
                                    key={opt}
                            ...
                            <div>
                              <label className="block text-sm font-medium text-gray-900 mb-2">
                                {t(
                                  "ambassador.contentCreator.specialCharacteristics",
                                )}
                              </label>
                              <input
                                type="text"
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg mb-6">
                      ...
                      <div className="p-6">
                        ...
                        <textarea
                          ...
                          placeholder={t(
                            "ambassador.common.motivationQuestion",
                          )}
                          maxLength={maxChars}
                          rows={4}
                    ...
                    <div className="mb-6">
                      ...
                      {errors.agreeToReview && (
                        <p className="text-red-500 text-xs mt-1">
                          {t("ambassador.common.errors.agreementRequired")}
                        </p>
                      )}
                    </div>
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg">
                      ...
                      <div className="p-6 space-y-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.breeder.options.speciesBreeds", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                          ...
                          {errors.speciesBreed && (
                            <p className="text-red-500 text-xs mt-1">
                              {t(
                                "ambassador.breeder.errors.speciesBreedRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.breeder.options.breedingDuration", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                          ...
                          {errors.breedingDuration && (
                            <p className="text-red-500 text-xs mt-1">
                              {t(
                                "ambassador.breeder.errors.breedingDurationRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            {t("ambassador.breeder.options.breedingSizes", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg">
                      ...
                      <div className="p-6 space-y-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.breeder.options.familiarity", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                              ...
                              >
                                <input
                                  ...
                                  value={option}
                                  checked={
                                    formData.familiarWithProducts === option
                                  }
                                  onChange={handleInputChange}
                                  className="w-4 h-4 text-black border-2 border-black accent-black cursor-pointer"
                                />
                          ...
                          {errors.familiarWithProducts && (
                            <p className="text-red-500 text-xs mt-1">
                              {t(
                                "ambassador.breeder.errors.familiarWithProductsRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t(
                              "ambassador.breeder.options.collaborationTypes",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg">
                      ...
                      <div className="p-6 space-y-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.groomer.options.specialities", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                          ...
                          {errors.speciesBreed && (
                            <p className="mt-1 text-xs text-red-600">
                              {t(
                                "ambassador.groomer.errors.specialityRequired",
                              )}
                            </p>
                          )}
                        </div>
                    ...
                    <div className="bg-white border border-gray-300 rounded-lg">
                      ...
                      <div className="p-6 space-y-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-4">
                            {t("ambassador.groomer.options.shareOptions", {
                              returnObjects: true,
                            }).map((option) => (
                              <label
                                key={option}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        {errors.firstName && (
                          <p className="mt-1 text-xs text-red-600">
                            {t(
                              "ambassador.common.errors.organizationNameRequired",
                            )}
                          </p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        {errors.contact && (
                          <p className="mt-1 text-xs text-red-600">
                            {t("ambassador.common.errors.contactNameRequired")}
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="p-6 space-y-5">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-2">
                          {t(
                            "ambassador.clubAssociation.options.organizationTypes",
                            { returnObjects: true },
                          ).map((option) => (
                        ...
                        {errors.organizationType && (
                          <p className="mt-1 text-xs text-red-600">
                            {t(
                              "ambassador.clubAssociation.errors.organizationTypeRequired",
                            )}
                          </p>
                        )}
                      </div>
                      ...
                      <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          {t(
                            "ambassador.clubAssociation.numberOfActiveMembers",
                          )}
                        </label>
                        <div className="space-y-2">
                          {t(
                            "ambassador.clubAssociation.options.memberCounts",
                            { returnObjects: true },
                          ).map((option) => (
                            <label key={option} className="flex items-center">
                              <input
                        ...
                        {errors.memberCount && (
                          <p className="mt-1 text-xs text-red-600">
                            {t(
                              "ambassador.clubAssociation.errors.memberCountRequired",
                            )}
                          </p>
                        )}
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {t("ambassador.clubAssociation.options.events", {
                            returnObjects: true,
                          }).map((option) => (
                            <label key={option} className="flex items-center">
                              <input
                        ...
                        {errors.organizeEvents && (
                          <p className="mt-1 text-xs text-red-600">
                            {t(
                              "ambassador.clubAssociation.errors.organizeEventsRequired",
                            )}
                          </p>
                        )}
                      </div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-300">
                    ...
                    <div className="p-6">
                      {breedGroups.map((group, index) => (
                        <div
                          key={group.id}
                          className={`mb-6 ${index > 0 ? "pt-6 border-t border-gray-200" : ""}`}
                        >
                        ...
                        >
                          ...
                          <div className="mb-4">
                            ...
                            <div className="flex flex-wrap gap-4">
                              {t("ambassador.clubAssociation.options.species", {
                                returnObjects: true,
                              }).map((option) => (
                                <label
                                  key={option}
                      ...
                      <div className="p-6">
                        ...
                        <div className="mb-6">
                          ...
                          {errors.collaborationReason && (
                            <p className="mt-1 text-xs text-red-600">
                              {t(
                                "ambassador.clubAssociation.errors.collaborationReasonRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-2 mb-4">
                            {t(
                              "ambassador.clubAssociation.options.promotionActions",
                              { returnObjects: true },
                            ).map((option) => (
                              <label key={option} className="flex items-center">
                                <input
                          ...
                          {errors.promotionActions && (
                            <p className="mt-1 text-xs text-red-600">
                              {t(
                                "ambassador.clubAssociation.errors.promotionActionsRequired",
                              )}
                            </p>
                          )}
                          ...
                          <div>
                            <label className="block text-sm text-gray-700 mb-2">
                              {t(
                                "ambassador.clubAssociation.otherTypeOfActions",
                              )}
                            </label>
                            <input
                              type="text"
                ...
                <div className="border border-gray-300 rounded-lg bg-white overflow-hidden">
                  ...
                  <div className="p-6 space-y-5">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-900 mb-3">
                        {t(
                          "ambassador.healthProfessional.professionSpeciality",
                        )}
                      </label>
                      <div className="flex flex-wrap gap-4">
                        {t(
                          "ambassador.healthProfessional.options.professions",
                          { returnObjects: true },
                        ).map((option) => (
                          <label
                            key={option}
                      ...
                      {errors.profession && (
                        <p className="mt-1 text-xs text-red-600">
                          {t(
                            "ambassador.healthProfessional.errors.professionRequired",
                          )}
                        </p>
                      )}
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-black mb-2">
                        {t(
                          "ambassador.healthProfessional.otherProfessionSpeciality",
                        )}
                      </label>
                      <input
                        type="text"
                      ...
                      <div className="p-6">
                        ...
                        <div className="mb-6">
                          <label className=" block mb-3 text-black">
                            {t(
                              "ambassador.healthProfessional.howLongPracticing",
                            )}
                          </label>
                          <div className="flex gap-6 flex-wrap text-xs font-medium">
                            {t(
                              "ambassador.healthProfessional.options.practicingYears",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                          ...
                          {errors.yearsExperience && (
                            <p className="mt-1 text-sm text-red-600">
                              {t(
                                "ambassador.healthProfessional.errors.yearsExperienceRequired",
                              )}
                            </p>
                          )}
                        </div>
                        ...
                        <div className="mb-6">
                          ...
                          <div className="flex gap-6 flex-wrap text-xs font-medium">
                            {t(
                              "ambassador.healthProfessional.options.workWith",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                        ...
                        <div>
                          <label className="block mb-3 text-black">
                            {t(
                              "ambassador.healthProfessional.familiarWithBiogance",
                            )}
                          </label>
                          <div className="text-sm flex gap-6 flex-wrap">
                            {t(
                              "ambassador.healthProfessional.options.familiarity",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                              ...
                              >
                                <input
                                  ...
                                  value={option}
                                  checked={
                                    formData.familiarWithBiogance === option
                                  }
                                  onChange={handleInputChange}
                                  className="accent-black cursor-pointer"
                                />
                    ...
                    <div className="bg-white rounded-lg border border-gray-200">
                      ...
                      <div className="p-6">
                        ...
                        <div className="mb-6">
                          <label className="block mb-3 text-black">
                            {t(
                              "ambassador.healthProfessional.wouldYouLikeToParticipate",
                            )}
                          </label>
                          <div className="space-y-2">
                            {t(
                              "ambassador.healthProfessional.options.participateIn",
                              { returnObjects: true },
                            ).map((option) => (
                              <label
                                key={option}
                        ...
                        <div>
                          <label className="block mb-3 text-black">
                            {t(
                              "ambassador.healthProfessional.expertArticleTopics",
                            )}
                          </label>
                          <div className="relative">
                            <textarea
                    ...
                    <div className="p-6 space-y-5">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex gap-3 flex-wrap">
                          {t("ambassador.animalWelfare.options.legalStatus", {
                            returnObjects: true,
                          }).map((option) => (
                            <label key={option} className="flex items-center">
                              <input
                        ...
                        {errors.legalStatus && (
                          <p className="mt-1 text-xs text-red-600">
                            {t(
                              "ambassador.animalWelfare.errors.legalStatusRequired",
                            )}
                          </p>
                        )}
                      </div>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex gap-3 flex-wrap">
                          {t("ambassador.animalWelfare.options.animalsInCare", {
                            returnObjects: true,
                          }).map((option) => (
                            <label key={option} className="flex items-center">
                              <input
                      ...
                      <div>
                        ...
                        <div className="gap-3 flex flex-wrap">
                          {t(
                            "ambassador.animalWelfare.options.speciesConcerned",
                            { returnObjects: true },
                          ).map((option) => (
                            <label key={option} className="flex items-center">
                              <input
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-6">
                        ...
                        <div className="flex gap-6 flex-wrap">
                          {t(
                            "ambassador.animalWelfare.options.hearAboutBiogance",
                            { returnObjects: true },
                          ).map((option) => (
                            <label
                              key={option}
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 gap-x-6 gap-y-2 mb-4">
                          {t(
                            "ambassador.animalWelfare.options.usefulProducts",
                            { returnObjects: true },
                          ).map((option) => (
                            <label
                              key={option}
                      ...
                      <div>
                        ...
                        <div className="flex gap-6">
                          {t(
                            "ambassador.animalWelfare.options.shareInitiatives",
                            { returnObjects: true },
                          ).map((option) => (
                            <label
                              key={option}
                    ...
                    <div className="p-6">
                      ...
                      <div className="relative">
                        <textarea
                          ...
                          onChange={handleInputChange}
                          placeholder={t(
                            "ambassador.animalWelfare.placeholders.shelterMessage",
                          )}
                          maxLength={250}
                          rows={4}
                          className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-300 transition resize-none"
