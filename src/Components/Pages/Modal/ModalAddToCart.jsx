      ...
      >
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "0 24px" }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ margin: "0 0 10px", fontSize: "13px", fontWeight: 600, color: "#111" }}>
                {name}
              </p>
          ...
          <div style={{ padding: "16px 0", borderBottom: "1px solid #e5e5e5" }}>
            {[
              { label: "Subtotal", value: `${parseFloat(subtotal).toLocaleString("fr-FR", { minimumFractionDigits: 2 })} €` },
              { label: "Delivery costs", value: `${deliveryCost.toFixed(2).replace(".", ",")} €` },
            ].map(({ label, value }) => (
              <div
                key={label}
                style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px", fontSize: "13px", color: "#555" }}
              >
                <span>{label}</span>
                <span>{value}</span>
              </div>
            ...
            <div
              style={{ display: "flex", justifyContent: "space-between", marginTop: "10px", fontSize: "14px", fontWeight: 700, color: "#111" }}
            >
          ...
          <div>
            ...
            <div
              style={{
                maxHeight: giftOpen ? `${giftContentHeight}px` : "0px",
                overflow: "hidden",
                ...
                {["none", "large"].map((val) => (
                  <label
                    ...
                    style={{
                      ...
                      padding: "10px 0",
                      cursor: "pointer",
                      borderBottom: val === "none" ? "1px solid #f0f0f0" : "none",
                    }}
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      <div
                        style={{
                          ...
                          height: "18px",
                          borderRadius: "50%",
                          border: `2px solid ${giftChoice === val ? "#111" : "#ccc"}`,
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          flexShrink: 0,
                      ...
                      >
                        <div
                          style={{
                            ...
                            borderRadius: "50%",
                            backgroundColor: "#111",
                            opacity: giftChoice === val ? 1 : 0,
                            transition: "opacity 0.2s ease",
                          }}
                        />
                      </div>
                      <span style={{ fontSize: "13px", color: "#111" }}>
                        {val === "none" ? "I don't want gift pouch" : "Large size - more than 3 products"}
                      </span>
                    </div>
                    {val === "large" && (
                      <span style={{ fontSize: "13px", color: "#111", fontWeight: 500, marginLeft: "12px" }}>
                        5,00 €
                      </span>
                    )}
                  </label>
        ...
        <div style={{ borderTop: "1px solid #e5e5e5", backgroundColor: "#fff" }}>
          ...
          <div style={{ padding: "14px 24px 0" }}>
            <div
              style={{ display: "flex", justifyContent: "space-between", fontSize: "12px", color: "#555", marginBottom: "7px" }}
            >
              <span>Complete for free shipping</span>
              <span style={{ fontWeight: 600, color: "#111" }}>{remaining} € remaining</span>
            </div>
            <div
              style={{ height: "4px", backgroundColor: "#e5e5e5", borderRadius: "2px", overflow: "hidden", marginBottom: "14px" }}
            >
              <div
                style={{
                  height: "100%",
