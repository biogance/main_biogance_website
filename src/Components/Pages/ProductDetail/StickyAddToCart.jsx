...
export default function StickyAddToCart({ price = 16.0, productName = "Biogance Universal 2-in-1 Shampoo", visible = false }) {
  ...
  return (
    ...
    >
      <div className="w-full px-6 lg:px-14 py-3 flex items-center justify-between gap-6">
        {/* Product Name */}
        ...
        {/* Add to Cart Button */}
        <button className="bg-[#1C1C1C] text-white text-[13px] font-semibold px-8 py-3 rounded-lg hover:bg-[#333] transition-colors cursor-pointer shrink-0">
