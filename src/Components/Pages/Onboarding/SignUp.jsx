    ...
    <div className=" bg-transparent flex items-center justify-center p-4">
      <div className="relative bg-white rounded-2xl shadow-lg w-full max-w-md p-8">
        ...
        <button
          type="button"
          onClick={handleClose}
          className="absolute -top-3 -right-3 w-10 h-10 bg-gray-400 hover:bg-gray-500 rounded-full flex items-center justify-center text-white transition-colors"
        >
        ...
        <div className="text-center mb-6">
          <h1 className="text-2xl mb-2 text-black">Create Your Biogance Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="fullName" className="block text-sm mb-2 text-black">
                Full Name
              </label>
              <input
                id="fullName"
          ...
          {/* Phone Number */}
          <div>
            <label htmlFor="phoneNumber" className="block text-sm mb-2 text-black">
              Phone Number
            </label>
            <PhoneInput
              defaultCountry="fr"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400 text-sm pr-10"
              />
              <button
                type="button"
        ...
        <div className="flex justify-center gap-4 mb-6">
          <button
            type="button"
            className="w-12 h-12 rounded-full bg-white border border-gray-300 flex items-center justify-center hover:bg-gray-50 transition-colors text-black"
          >
