                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className="flex-1 px-8 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                        ...
                        <button
                            type="submit"
                            className="flex-1 px-8 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors"
                            style={{ fontSize: '14px', fontWeight: 600 }}
                        >
                            Submit
                        </button>
