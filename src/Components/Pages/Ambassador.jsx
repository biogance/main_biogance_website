                                ...
                                <div className="min-h-screen py-8">
                                    <div className="max-w-5xl mx-auto">
                                        ...
                                        <div className="flex gap-4">
                                            <button className="flex-1 bg-white text-black py-4 rounded-md text-sm font-semibold border border-gray-300 hover:bg-gray-50 transition">
                                                Cancel
                                            </button>
                                            <button className="flex-1 bg-black text-white py-4 rounded-md text-sm font-semibold hover:bg-gray-800 transition">
                                                Submit
                                            </button>
                                        </div>
                                    </div>
