          ...
          <main className="page-shell">
            ...
            <section className="hero">
              <div className="hero-copy">
                ...
                <div
                  className="hero-meta"
                  aria-label="Biogance professional highlights"
                >
            ...
            <section className="route-section" id="choose">
              <div className="section-head refined-head">
                <div>
                  ...
                  <h2 style={{ marginTop: "30px" }} className="section-title">
                    {t("route.title")}
                  </h2>
                </div>
              ...
              <div
                className="route-choice-grid"
                aria-label="Professional application routes"
              >
                <article
                ...
                >
                  <div className="route-card-top">
                    <span className="route-label">
                      {t("route.reseller.routeLabel")}
                    </span>
                    <span className="route-code">
                      {t("route.reseller.code")}
                    </span>
                  </div>
                  <div className="route-card-main">
                    ...
                    <h3 style={{ marginTop: "20px" }}>
                      {t("route.reseller.title")}
                    </h3>
                    <p>{t("route.reseller.description")}</p>
                  </div>
                  <div className="route-card-bottom">
                    <ul>
                      {t("route.reseller.bullets", { returnObjects: true }).map(
                        (item) => (
                          <li key={item}>{item}</li>
                        ),
                      )}
                ...
                <article
                  ...
                  onClick={() => {
                    startTopLoader();
                    router.push("/become-an-ambassador");
                  }}
                  style={{ cursor: "pointer" }}
                >
                  <div className="route-card-top">
                    <span className="route-label">
                      {t("route.partner.routeLabel")}
                    </span>
                    <span className="route-code">
                      {t("route.partner.code")}
                    </span>
                  </div>
                  <div className="route-card-main">
                    <div className="kicker-row">
                    ...
                    <h3 style={{ marginTop: "20px" }}>
                      {t("route.partner.title")}
                    </h3>
                    <p>{t("route.partner.description")}</p>
                  </div>
                  <div className="route-card-bottom">
                    <ul>
                      {t("route.partner.bullets", { returnObjects: true }).map(
                        (item) => (
                          <li key={item}>{item}</li>
                        ),
                      )}
            ...
            <section className="editorial-split" id="partners">
              ...
              <div
                className={`editorial-visual${footerVisualMedia?.media ? " has-media" : ""}`}
              >
            ...
            <section className="resource-band" id="catalogues">
              ...
              <div className="resource-list">
                ...
                <div className="resource-item">
                  ...
                  <Link
                    className="tiny-link hover:!underline"
                    href="/become-a-reseller"
                  >
            ...
            <section className="final-cta" id="apply">
              ...
              <div className="social-row">
                <a
                  href="https://www.instagram.com/bioganceofficiel"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://youtube.com/@bioganceofficiel?si=IJV8iaJ1YTgSos8z"
                  target="_blank"
                  rel="noreferrer"
                >
